...
namespace UnderdogsEnhanced
{
    public static class LeopardMain
    {
        ...
        private static readonly HashSet<string> leopard1_peri_r12_variants = new HashSet<string>(new string[]
        {
            "Leopard 1A4"
        }, StringComparer.OrdinalIgnoreCase);
        ...
        public static void Config(MelonPreferences_Category cfg)
        {
            ...
            ammoEntry1A5.Comment = "AP round type selection: Default=vanilla, DM33=420mm penetration, DM63=447mm penetration";
        ...
        private static void CreateVariantPreferences(MelonPreferences_Category cfg, string variant)
        {
            ...
            convertEntry.Comment = "Convert to Leopard 1A5 (EMES-18 sight + new turret appearance); disable to keep vanilla appearance";
            leopard1_convert_prefs[variant] = convertEntry;

            var emes18Entry = cfg.CreateEntry($"{variant} EMES18 FCS Only", false);
            emes18Entry.Comment = $"Apply EMES-18 fire control system only, without model changes; only effective when '{variant} Convert to 1A5' is disabled";
            leopard1_emes18_prefs[variant] = emes18Entry;

            var ammoEntry = cfg.CreateEntry($"{variant} Ammo AP Rounds", "Default");
            ammoEntry.Comment = "AP round type selection: Default=vanilla, DM33=420mm penetration, DM63=447mm penetration";
        ...
        {
            return string.Equals(vehicleName, "Leopard 1A1A4", StringComparison.OrdinalIgnoreCase)
        ...
        internal static void Apply(Vehicle vic)
        {
            ...
            bool leopardUsesPeriR12 = leopard1_peri_r12_variants.Contains(name);
